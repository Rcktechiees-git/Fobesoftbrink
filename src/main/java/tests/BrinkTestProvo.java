...
public class BrinkTestProvo extends BaseTest{
		...
		System.out.println("Net sales amount is :" + netSaleAmount);
		 ...
		 //fobesoft
    		...
    		Actions actions = new Actions(driver);
    		        ...
    		        brink.utils.waitForElementVisibility(By.xpath("(//td[@title='Net Sales']//following-sibling::td)[1]"), 20);
    		      WebElement element = driver.findElement(By.xpath("(//td[@title='Net Sales']//following-sibling::td)[1]"));
    		        actions.doubleClick(element).build().perform(); 
    		        brink.utils.waitForElementVisibility(By.xpath("//td[@title='Net Sales']//following-sibling::td[1]/div/div/div/div/div/input"), 120);
    		    	WebElement element1 = driver.findElement(By.xpath("//td[@title='Net Sales']//following-sibling::td[1]/div/div/div/div/div/input"));
    		    	Thread.sleep(1000);
